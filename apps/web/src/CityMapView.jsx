...
// The literal map for the explore landing: committed, pre-projected state/country
...
// collide). Only the active product's cities get a dot. Purely presentational —
// which map geometry to draw is the caller's job (CityMapUS.jsx / CityMapWorld.jsx).
export default function CityMapView({ onPick, ranked, cities, MAP, useWorld }) {
