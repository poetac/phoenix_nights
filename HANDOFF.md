...
- The product is now a **generalized, worldwide city-climate engine**, not a single page:
  ...
  - **15 cities**, registry-driven: 14 US — Phoenix (curated flagship), Tucson, Las
    Vegas, El Paso, Yuma, Reno, Albuquerque, Salt Lake City, Boise (arid West) +
    Atlanta, Houston, New Orleans, Raleigh, Dallas (humid South/Gulf) — **plus Sydney,
    AU, the first international city** (`source:"ghcn"`, NCEI GSOY, `units:"metric"`).
